...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-center gap-2 px-8 py-5.5 lg:py-2 ">
        <NavLink to="/">
      ...
      <div className='flex justify-center lg:hidden'>
        ...
        className='text-4xl px-2 py-2 bg-white rounded-full flex justify-center items-center backdrop-filter backdrop-blur-sm bg-opacity-70 border text-black'><IoClose /></button>
      </div>
    </aside>
  );
};
