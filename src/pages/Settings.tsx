...
<div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Active Driver" total="50" rate="">
          <svg
        ...
        <CardDataStats title="Total Active Rides" total="50" rate="" >
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Total Earnings" total="50" rate="" >
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
        ...
        <CardDataStats title="Your Earnings" total="50" rate="" >
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"
